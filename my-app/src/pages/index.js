    ...
    if(liquidityTab){
        ...
        <div>
          ...
          <div>
            {utils.parseEther(reservedCD.toString()).eq(zero) ? (
              ...
              <div>
                ...
                <div className={styles.inputDiv}>
                  {`You will need ${utils.formatEther(addCDTokens)} Crypto 
                    Dev Tokens`}
                </div>
            ...
            <div>
              ...
              />
              <div className={styles.inputDiv}>
                {`You will get ${utils.formatEther(removeCD)} Crypto Dev 
      ...
      return (
        <div>
          ...
          <div className={styles.inputDiv}>
            {ethSelected ? 
            `You will get ${utils.formatEther(tokenToBeReceivedAfterSwap)} Crypto
            Dev Tokens`
